...
# From https://github.com/noelbush/py_email_validation/
...
class Email(FancyValidator):
    ...
    ::
        ...
        Traceback (most recent call last):
            ...
        Invalid: The username portion of the email address is invalid (the portion before the @: test")
    ...
    usernameRE = re.compile(r"^"+LOCAL_PART+"$", re.I)
    domainRE = re.compile(r"^"+DOMAIN+"$", re.I)
